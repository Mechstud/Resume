...
\resheading{Summary}
\begin{itemize}
	\item[] Hands-on technology leader with 15+ years of experience building and scaling cloud-based SaaS products. Architect and full-stack engineer who writes production code across backend (Golang), frontend (ReactJS), and infrastructure layers. Spearheaded a PHP $\rightarrow$ \textbf{Golang} backend migration at scale and delivered multiple production \textbf{React} frontends across two ventures. Deep SQL and DBA experience with relational databases at scale (query optimisation, replication, ProxySQL). Manages DevOps pipelines end-to-end — CI/CD with Jenkins and GitHub Actions, configuration management with Ansible, and Linux server administration. Built and led engineering teams of 25--40 developers from scratch across two ventures.
\end{itemize}
...
\iffalse % Removed: school-level entries; redundant alongside M.Sc. + IIT B.Tech.
	\item
...
\begin{itemize}
	...
	\begin{itemize}
	  ...
	  \resitem{Built 5 large scale tax compliance products from ground up, \textit{viz.}, ExpressGST, ExpressTDS, ExpressITR, ExpressReco, SpectrumCloud and, couple of internal applications for license management, CRM, etc.}
	  \resitem{Built a cloud engineering team of 25+ developers from scratch; championed continuous reskilling through a PHP (Laravel) $\rightarrow$ Golang backend migration and ongoing adoption of AI/LLM-assisted development --- upskilling engineers at every inflection point rather than replacing them.}
	  \resitem{Technologies: Golang, PHP, MySQL, Postgres, ReactJS, Python, Nginx, Apache2, ProxySQL, Jenkins, Ansible, GitHub Actions, Git etc. }
...
\begin{enumerate}
	\resitem{{\small \textbf{PIPE - Pipeline Industry Professional Education}, November 13, 2014.}}
...
\end{itemize}
\vspace{4pt}\hrule\vspace{2pt}\hrule\vspace{4pt}
